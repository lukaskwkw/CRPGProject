#include "Combat/Animation/AnimNotify_CombatMissReactionWindow.h"
...
void UAnimNotify_CombatMissReactionWindow::Notify(USkeletalMeshComponent *MeshComp, UAnimSequenceBase *Animation, const FAnimNotifyEventReference &EventReference)
{
    ...
    {
        CombatExecutionSubsystem->TriggerPendingMissReactionWindow(TacticalUnitComponent);
    }
}